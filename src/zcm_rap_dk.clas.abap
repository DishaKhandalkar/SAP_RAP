  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF date_interval,
        msgid TYPE symsgid VALUE 'ZRAP_MESSAGES',
    ...
    METHODS constructor
      IMPORTING
        severity   LIKE if_abap_behv_message=>m_severity DEFAULT if_abap_behv_message=>severity-error
...
CLASS ZCM_RAP_DK IMPLEMENTATION.
